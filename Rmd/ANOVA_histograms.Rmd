...
data <- read_csv(paste0(data_dir,"/ANOVA/kidney_anova_slope_output.csv"))
```
...
## Effects on mRNA
```{r plotting mRNA, echo = FALSE}
grid.arrange(pval_mRNA_age, pval_mRNA_sex, ncol =2)
```

## Effects on protein 
```{r plotting protein, echo =FALSE}
grid.arrange(pval_protein_age, pval_protein_sex, ncol = 2)
```

## Effects of Age:Sex interaction of mRNA and protein
```{r plotting age/sex interaction, echo = FALSE}
